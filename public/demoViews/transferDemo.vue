          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td>callback</td>
                <td>
                  获取接口数据成功后的回调函数.参数为接口数据格式化后的data对象数组
                </td>
                <td>function</td>
                <td>—</td>
                <td>—</td>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  elementUI的change事件返回的是key字符串数组。nui-chang返回的是包括key和label组成的对象数组
                </td>
              </tr>
            </tbody>
          </table>
