...
const routes = [
...

  {
    path: '/splitPane',
    name: 'nui-split-pane',
    component: () => import('@/demoViews/splitPaneDemo.vue')
  },

  {
    path: '/themePicker',
    name: 'nui-theme-picker',
    component: () => import('@/demoViews/themePickerDemo.vue')
  },
  ...
  },
  {
    path: '/collapse',
    name: 'nui-collapse',
    component: () => import('@/demoViews/collapseDemo.vue')
  },
  {
    path: '/divider',
    name: 'nui-divider',
